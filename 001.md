...
Note that the application is specifying the path of the application contents to upload `path: build/libs/spring-music-1.0.jar` . This jar file still needs to be built which we will do in the next step
